# Evaluation Snapshot
## Prompt
Invoke titan-receipt for an explicit Titan service-cohort route that must stay gated, owner-grounded, and reviewable.
## Expected selection
use
## Why
...
## Expected object
Decision: use `titan-receipt`. Apply the explicit Titan service-cohort overlay while preserving owner truth, gates, and reviewable evidence.
## Boundary notes
