# Evaluation Snapshot
## Prompt
Three reviewed quest runs keep repeating the same bounded post-session triage pattern, and we need to decide whether it should stay a quest or be promoted into skill, playbook, memo, proof, or orchestrator surfaces.
## Expected selection
use
## Why
