...
|---|---|---|---|---:|---:|---|---|---|---|
| aoa-adr-write | evaluated | core | true | 1 | 0 | aoa-source-of-truth-check | decision_docs_authority | true | - |
| aoa-approval-gate-check | canonical | risk | true | 3 | 0 | aoa-dry-run-first, aoa-safe-infra-change, aoa-sanitized-share | risk_authority_preview_execution | true | - |
...
| aoa-dry-run-first | evaluated | risk | true | 2 | 0 | aoa-approval-gate-check, aoa-sanitized-share | risk_authority_preview_execution | true | - |
| aoa-invariant-coverage-audit | canonical | core | true | 1 | 0 | aoa-property-invariants | invariant_authoring_vs_audit | true | - |
| aoa-local-stack-bringup | scaffold | risk | false | 0 | 0 | - | - | false | - |
...
| aoa-safe-infra-change | evaluated | risk | true | 2 | 0 | aoa-approval-gate-check, aoa-sanitized-share | risk_authority_preview_execution | true | - |
| aoa-sanitized-share | evaluated | risk | true | 3 | 0 | aoa-approval-gate-check, aoa-dry-run-first, aoa-safe-infra-change | risk_authority_preview_execution | true | - |
| aoa-source-of-truth-check | evaluated | core | true | 1 | 0 | aoa-adr-write | decision_docs_authority | true | - |
