...
| aoa-bounded-context-map | evaluated | core | explicit-preferred | 1 | 1 | 2 | 1 | 1 | `skills/aoa-bounded-context-map/examples/example.md` | `docs/reviews/status-promotions/aoa-bounded-context-map.md` | - | true | - |
