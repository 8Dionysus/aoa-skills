...
- states: clean=131, drifted=13

## Findings

- `missing_autonomy_check`: 1
- `technique_source_drift`: 13
...
| `aoa-eval` | `scaffold` | `core` | `working_scaffold_needs_promotion_review` | `technique_source_drift` |
| `aoa-eval-apply` | `scaffold` | `core` | `working_scaffold_needs_promotion_review` | `technique_source_drift` |
| `aoa-eval-design` | `scaffold` | `core` | `working_scaffold_needs_promotion_review` | - |
| `aoa-eval-local-need` | `scaffold` | `core` | `working_scaffold_needs_promotion_review` | `technique_source_drift` |
| `aoa-eval-select` | `scaffold` | `core` | `working_scaffold_needs_promotion_review` | `technique_source_drift` |
...
| `aoa-session-self-repair` | `evaluated` | `core` | `working_with_maintenance_findings` | `technique_source_drift` |
| `aoa-summon` | `evaluated` | `core` | `working_with_maintenance_findings` | `technique_source_drift` |
| `os-abyss-artifact-trust-loop` | `scaffold` | `project` | `working_scaffold_needs_promotion_review` | `missing_autonomy_check` |
| `titan-approval-ledger` | `scaffold` | `project` | `working_scaffold_needs_promotion_review` | - |
| `titan-approval-loom` | `scaffold` | `project` | `working_scaffold_needs_promotion_review` | `technique_source_drift` |
| `titan-appserver-bridge` | `scaffold` | `project` | `working_scaffold_needs_promotion_review` | - |
| `titan-appserver-plan` | `scaffold` | `project` | `working_scaffold_needs_promotion_review` | `technique_source_drift` |
| `titan-closeout` | `scaffold` | `project` | `working_scaffold_needs_promotion_review` | - |
| `titan-console` | `scaffold` | `project` | `working_scaffold_needs_promotion_review` | `technique_source_drift` |
...
| `titan-mutation-gate` | `scaffold` | `project` | `working_scaffold_needs_promotion_review` | `technique_source_drift` |
...
| `titan-runtime-gate` | `scaffold` | `project` | `working_scaffold_needs_promotion_review` | `technique_source_drift` |
| `titan-summon` | `scaffold` | `project` | `working_scaffold_needs_promotion_review` | `technique_source_drift` |
| `titan-thread-turn-binding` | `scaffold` | `project` | `working_scaffold_needs_promotion_review` | `technique_source_drift` |
...
| `aoa-eval` | `scaffold` | `published` | `clean2/drifted1` | `a1/u7/d3/su3/sd2` | `out7/c14/r15/v17/p12` | `portable-core, repo, implicit=true` | `working_scaffold_needs_promotion_review` |
| `aoa-eval-apply` | `scaffold` | `published` | `clean2/drifted1` | `a1/u2/d1/su2/sd1` | `out5/c8/r9/v10/p13` | `portable-core, repo, implicit=false` | `working_scaffold_needs_promotion_review` |
...
| `aoa-eval-local-need` | `scaffold` | `published` | `clean2/drifted1` | `a1/u1/d1/su1/sd1` | `out4/c5/r5/v6/p7` | `portable-core, repo, implicit=false` | `working_scaffold_needs_promotion_review` |
| `aoa-eval-select` | `scaffold` | `published` | `clean2/drifted1` | `a1/u1/d1/su1/sd1` | `out4/c5/r5/v6/p8` | `portable-core, none, implicit=false` | `working_scaffold_needs_promotion_review` |
...
| `aoa-session-self-repair` | `evaluated` | `published` | `clean1/drifted1` | `a1/u2/d1/su1/sd1` | `out7/c11/r7/v8/p11` | `portable-core, none, implicit=false` | `working_with_maintenance_findings` |
...
| `aoa-summon` | `evaluated` | `published` | `clean3/drifted1` | `a1/u1/d1/su1/sd1` | `out7/c12/r7/v12/p15` | `portable-core, none, implicit=false` | `working_with_maintenance_findings` |
...
| `os-abyss-artifact-trust-loop` | `scaffold` | `published` | `clean3` | `a0/u1/d1/su1/sd1` | `out6/c8/r8/v8/p10` | `project-overlay, runtime, implicit=false` | `working_scaffold_needs_promotion_review` |
...
| `titan-approval-loom` | `scaffold` | `published` | `clean2/drifted1` | `a1/u1/d1/su1/sd1` | `out4/c5/r5/v5/p5` | `project-overlay, repo, implicit=false` | `working_scaffold_needs_promotion_review` |
...
| `titan-appserver-plan` | `scaffold` | `published` | `clean2/drifted1` | `a1/u1/d1/su1/sd1` | `out5/c5/r5/v5/p5` | `project-overlay, repo, implicit=false` | `working_scaffold_needs_promotion_review` |
...
| `titan-console` | `scaffold` | `published` | `clean2/drifted1` | `a1/u1/d1/su1/sd1` | `out5/c5/r5/v5/p5` | `project-overlay, repo, implicit=false` | `working_scaffold_needs_promotion_review` |
...
| `titan-mutation-gate` | `scaffold` | `published` | `clean2/drifted1` | `a1/u1/d1/su1/sd1` | `out5/c5/r5/v5/p5` | `project-overlay, repo, implicit=false` | `working_scaffold_needs_promotion_review` |
...
| `titan-runtime-gate` | `scaffold` | `published` | `clean2/drifted1` | `a1/u1/d1/su1/sd1` | `out5/c5/r5/v5/p5` | `project-overlay, repo, implicit=false` | `working_scaffold_needs_promotion_review` |
| `titan-summon` | `scaffold` | `published` | `clean2/drifted1` | `a1/u1/d1/su1/sd1` | `out5/c5/r5/v5/p6` | `project-overlay, none, implicit=false` | `working_scaffold_needs_promotion_review` |
| `titan-thread-turn-binding` | `scaffold` | `published` | `clean2/drifted1` | `a1/u1/d1/su1/sd1` | `out5/c5/r5/v5/p5` | `project-overlay, repo, implicit=false` | `working_scaffold_needs_promotion_review` |
