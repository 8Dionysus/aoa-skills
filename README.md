...
- packaging and relationship views: `generated/skill_bundle_index.md`, `generated/skill_graph.md`, and `generated/skill_composition_audit.md`
- public status and governance readouts: `generated/public_surface.md` and `generated/governance_backlog.md`
...
- portable export and local runtime seams: `docs/CODEX_PORTABLE_LAYER.md`, `docs/LOCAL_ADAPTER_CONTRACT.md`, `docs/RUNTIME_SEAM_SECOND_PATH.md`, `docs/RUNTIME_TOOL_CONTRACTS.md`, `docs/SESSION_COMPACTION.md`, and `.agents/skills/*`
...
- activation quality and conformance: `docs/DESCRIPTION_TRIGGER_EVALS.md` and `docs/SKILLS_REF_VALIDATION.md`
