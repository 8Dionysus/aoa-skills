...
This guide is separate from runtime selection in `mechanics/release-support/docs/RUNTIME_PATH.md` and separate from derived public status in `mechanics/audit/docs/PUBLIC_SURFACE.md`.
If you are choosing an object, start with runtime. If you are judging evidence, start here.

## Layer map

- `mechanics/release-support/docs/RUNTIME_PATH.md` - pick, inspect, expand, object use
- `mechanics/audit/docs/EVALUATION_PATH.md` - evidence, matrix output, snapshot-backed coverage
- `mechanics/audit/docs/PUBLIC_SURFACE.md` - derived governance and public-product signals
