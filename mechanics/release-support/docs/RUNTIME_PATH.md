...
If you need maturity, promotion, or public-product state, switch to `mechanics/audit/docs/PUBLIC_SURFACE.md`.
If you need to judge behavior evidence, switch to `mechanics/audit/docs/EVALUATION_PATH.md`.
...
Those belong in `mechanics/audit/docs/EVALUATION_PATH.md`, `mechanics/audit/docs/PUBLIC_SURFACE.md`, and the generated surface docs.
