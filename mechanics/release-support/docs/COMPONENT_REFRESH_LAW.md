...
This law complements `mechanics/release-support/docs/CODEX_PORTABLE_LAYER.md`.
It does not make `aoa-skills` a hidden auto-mutator, scheduler, or owner of
downstream workspace installs.
