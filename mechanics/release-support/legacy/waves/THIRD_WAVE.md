...
`generated/release_manifest.json` is the machine-readable portable release contract for this layer. It pins artifact groups, digests, bundle revisions, and install-profile revisions without replacing repo-level release identity in `CHANGELOG.md`, `mechanics/release-support/docs/RELEASING.md`, the Git tag, or the GitHub release body.
