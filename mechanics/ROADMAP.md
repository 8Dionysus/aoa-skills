...
- derived public-surface signaling in `mechanics/audit/docs/PUBLIC_SURFACE.md` and `generated/public_surface.*`
- repo-level baseline release identity in `CHANGELOG.md`, `mechanics/release-support/docs/RELEASING.md`, tags, and GitHub release notes
...
- local Codex or MCP disclosure plus adapter and compaction guidance in `mechanics/boundary-bridge/docs/CODEX_SKILL_MCP_WIRING.md`, `mechanics/release-support/docs/LOCAL_ADAPTER_CONTRACT.md`, and `mechanics/release-support/docs/SESSION_COMPACTION.md`
...
- the active mechanics package routes under `mechanics/README.md`,
  ...
  `mechanics/agon/`, `mechanics/audit/`, `mechanics/experience/`,
  `mechanics/boundary-bridge/`, and `mechanics/release-support/`
...
Another structure risk is remaining distillation and package-deepening
pressure: accepted owner requests and residual mechanics-shaped source
surfaces should move one bounded package at a time through `mechanics/`, with
...
- `mechanics/boundary-bridge/docs/OVERLAY_SPEC.md` and `mechanics/boundary-bridge/overlays/atm10/PROJECT_OVERLAY.md` define the repo-local overlay contract for live exemplar packs without turning them into downstream integrations
