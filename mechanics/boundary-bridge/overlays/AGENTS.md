...
Guidance for coding agents and humans working under `mechanics/boundary-bridge/overlays/`.

## Purpose

`mechanics/boundary-bridge/overlays/` stores family-level live exemplar overlay packs for `aoa-skills`. These documents explain how a public base skill is adapted to a repository family without pretending to be a downstream integration or a playbook.
