...
- [CHECKPOINT_NOTE_PATH.md](../../checkpoint/docs/CHECKPOINT_NOTE_PATH.md) for lower-authority checkpoint capture
...
- [QUESTBOOK_SKILL_INTEGRATION.md](../../questbook/docs/QUESTBOOK_SKILL_INTEGRATION.md) for the installed session-harvest family posture
