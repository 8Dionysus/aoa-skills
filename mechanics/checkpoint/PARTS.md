...
| [Closeout Bridge Boundary](parts/closeout-bridge-boundary/README.md) | route reviewed checkpoint hints into explicit closeout bridge execution without hiding harvest | `skills/core/session-growth/aoa-checkpoint-closeout-bridge/SKILL.md` owns bridge workflow; core session-growth skills own their own steps |
