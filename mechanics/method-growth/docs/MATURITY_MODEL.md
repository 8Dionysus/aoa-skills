...
For reading the evidence itself, use `mechanics/audit/docs/EVALUATION_PATH.md`.
...
- public-product and governance signals remain readable in `mechanics/audit/docs/PUBLIC_SURFACE.md`
