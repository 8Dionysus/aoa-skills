...
- `PYTHONPATH=scripts python scripts/validation/validate_skill_mcp_wiring.py --workspace-config /home/dionysus/.codex/config.toml --local-adapter-manifest generated/local_adapter_manifest.min.json`
