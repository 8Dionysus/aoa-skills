...
- reviewed revision: `79434b7b4046`
...
- next status after this step: canonical maintenance now lives in `docs/reviews/canonical-candidates/aoa-adr-write.md` and `docs/governance/lanes.md`.
...
- blockers for the next status step: none for the current status; maintain default-reference drift through `docs/reviews/canonical-candidates/aoa-adr-write.md` and `docs/governance/lanes.md`.
