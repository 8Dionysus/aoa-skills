...
Use this checklist when reviewing `titan-console` output inside an explicit Titan service-cohort route.
...
- [ ] The console shows Atlas, Sentinel, Mneme, Forge, and Delta lane status separately.
- [ ] Forge and Delta remain locked unless matching approval refs are present.
- [ ] Stale or contradictory console state is surfaced as a warning, not normalized away.
