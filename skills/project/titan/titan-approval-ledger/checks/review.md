...
Use this checklist when reviewing `titan-approval-ledger` output inside an explicit Titan service-cohort route.
...
- [ ] The approval names exactly one gate kind: Forge mutation or Delta judgment.
- [ ] The approval text is linked to a receipt, target, evidence packet, and operator-visible source.
- [ ] The ledger preserves what remains blocked after approval.
