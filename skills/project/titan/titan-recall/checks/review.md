...
Use this checklist when reviewing `titan-recall` output inside an explicit Titan service-cohort route.
...
- [ ] Recall hits include record id, source refs, confidence, state, and authority note.
- [ ] Candidate, confirmed, redacted, and tombstoned states remain distinct.
- [ ] The result routes important claims back to sources before use.
