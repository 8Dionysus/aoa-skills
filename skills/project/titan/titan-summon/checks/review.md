...
Use this checklist when reviewing `titan-summon` output inside an explicit Titan service-cohort route.
...
- [ ] The summon is explicit and names the workspace or session root.
- [ ] Atlas, Sentinel, and Mneme are active as service lanes; Forge and Delta are locked.
- [ ] The receipt names route, risk, memory posture, gate status, and next move.
