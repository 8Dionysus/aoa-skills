#!/usr/bin/env python3
"""Preview, check, or build one repository-owned v1 skill projection."""
...
def parse_args() -> argparse.Namespace:
    ...
    action.add_argument(
        "--execute", action="store_true", help="Write the declared v1 projection"
    )
    parser.add_argument(
        "--prune",
        action="store_true",
        help=(
            "With --execute, remove undeclared entries from the projection root "
