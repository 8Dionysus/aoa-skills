...
from skill_model import skill_relationship_contract
...
def release_manifest_artifact_identity() -> dict[str, Any]:
    return {
        ...
        "producer": (
            "scripts/export/release_manifest_contract.py from generated export "
            "surfaces, skill bundle indexes, install profiles, artifact groups, "
            "and CHANGELOG release identity"
        ),
        "consumer_expectation": (
            "Verify schema_version, artifact_identity, profile, artifact groups, "
            "authoring and generated file digests, skill bundle revisions, "
            "install profile revisions, and release_identity before using this "
            "as the portable export release contract; verify staged bundle "
            "manifests or installed profiles separately before trusting a handoff."
        ),
        "privacy_boundary": (
            "Public-safe generated export metadata and digests only; no secrets, "
            "live downstream adoption truth, host runtime state, or private "
            "workspace evidence."
        ),
        "content_identity": (
            "generated/release_manifest.json generated by build_release_manifest() "
            "and validated against schemas/release_manifest.schema.json."
        ),
