...
from runtime.skill_runtime_guardrails import activate_guarded_payload, load_guardrails, render_markdown
...
def legacy_payload(runtime_payload: dict[str, Any], docs: dict[str, Any], skill_name: str) -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        "skill": {
            ...
            "implicit_activation_policy": skill.get("implicit_activation_policy"),
