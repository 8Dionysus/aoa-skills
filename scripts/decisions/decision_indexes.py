...
def render_generated_notice() -> str:
    return (
        "<!-- Generated by scripts/decisions/generate_decision_indexes.py; "
        "do not edit by hand. -->\n\n"
    )
        ...
        if path.read_text(encoding="utf-8") != expected_text:
            issues.append(
                (
                    ...
                    "generated decision index is stale; run PYTHONPATH=scripts python scripts/decisions/generate_decision_indexes.py",
                )
            )
    return issues
