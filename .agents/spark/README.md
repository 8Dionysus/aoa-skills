...
`.agents/spark/` is the Codex Spark fast-session lane for `aoa-skills`.

Use it when a small model can finish one bounded skill-canon scenario or
...
launch, result, and handoff material. It does not author canonical skill
meaning, mechanic law, generated truth, proof authority, playbook composition,
role contracts, memory objects, or runtime state.
...
| Scenario | Use |
|---|---|
| [skill-audit](scenarios/skill-audit/README.md) | read-only audit of boundedness, duplicate meaning, stale paths, public hygiene, and owner route |
| [skill-refinement](scenarios/skill-refinement/README.md) | one small source-backed patch to an existing skill bundle |
| [overlay-scout](scenarios/overlay-scout/README.md) | map donor, overlay, legacy, or mechanic-local material before deeper skill-layer work |
| [portable-export-check](scenarios/portable-export-check/README.md) | inspect `.agents/skills/*` export parity and adoption-facing drift |
| [diff-review](scenarios/diff-review/README.md) | review a concrete diff or PR for skill-canon risk and missed checks |
