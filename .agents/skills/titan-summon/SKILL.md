...
metadata:
  ...
  aoa_technique_dependencies: AOA-T-0060,AOA-T-0058,AOA-T-0028
...
- AOA-T-0060 from `8Dionysus/aoa-techniques` at `3b1d5d623569aa4920b87280d0db0e911d2e29d5` using path `techniques/continuity/handoff-continuation/session-opening-ritual-before-work/TECHNIQUE.md` and sections: Intent, Inputs, Outputs, Core procedure, Contracts, Risks, Validation
