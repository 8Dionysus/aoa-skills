...
Use this checklist when reviewing `titan-receipt` output inside an explicit Titan service-cohort route.
...
- [ ] The receipt records source refs, gate refs, validation refs, and state.
- [ ] Open, allowed, blocked, candidate, and closed states are not blurred.
- [ ] The receipt is framed as witness evidence, not final owner truth.
