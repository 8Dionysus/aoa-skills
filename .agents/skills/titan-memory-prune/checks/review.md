...
Use this checklist when reviewing `titan-memory-prune` output inside an explicit Titan service-cohort route.
...
- [ ] Prune output is a proposal, not silent deletion or canon rewrite.
- [ ] Each retain, redact, tombstone, merge, or defer decision keeps source refs.
- [ ] Destructive memory changes require owner approval and rollback posture.
